...
{
    public class PhoneApplicationPageEx : PhoneApplicationPage, IActivityContainer, INotifyPropertyChanged
    {        
        ...
        #region Constructor
        public PhoneApplicationPageEx() : base()
        {
            ...
            if (ApplicationEx.Instance.HasOpenSession)
            {
                ...
                {
                    this.Loaded += new RoutedEventHandler(PhoneApplicationPageEx_Loaded);
                    this.BackKeyPress += new EventHandler<CancelEventArgs>(PhoneApplicationPageEx_BackKeyPress);
        ...
        private void PhoneApplicationPageEx_BackKeyPress(object sender, CancelEventArgs e)
        {
