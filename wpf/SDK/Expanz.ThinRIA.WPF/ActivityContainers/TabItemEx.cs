...
{
    public class TabItemEx : TabItem, IActivityContainer, INotifyPropertyChanged
    {
        #region Member Variables
        protected ActivityHarness _harness;
        public ActivityHarness Harness { get { return _harness; } }
        ...
        public TabItemEx() : base()
        {
            ...
            if (ApplicationEx.Instance.HasOpenSession)
            {
                ...
                if (!System.ComponentModel.DesignerProperties.GetIsInDesignMode(this))
                {
                    ...
                    this.Unloaded += new RoutedEventHandler(TabItemEx_Unloaded);
        ...
        private void TabItemEx_Unloaded(object sender, RoutedEventArgs e)
        {
