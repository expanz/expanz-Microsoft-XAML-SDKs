...
{
    public class ActivityPanelEx : Panel, IActivityContainer, INotifyPropertyChanged, IDisposable
    {
        ...
        public ActivityPanelEx() : base()
        {
            ...
            if (ApplicationEx.Instance.HasOpenSession)
            {
                ...
                {
                    this.Loaded += new RoutedEventHandler(ActivityPanelEx_Loaded);
                    this.Unloaded += new RoutedEventHandler(ActivityPanelEx_Unloaded);
        ...
        private void ActivityPanelEx_Unloaded(object sender, RoutedEventArgs e)
        {
